...
import at.favre.lib.crypto.bcrypt.BCrypt; // <-- NUEVO IMPORT
...
import java.sql.PreparedStatement; // <-- NUEVO IMPORT
...
public class ApiIntegrationTest {
    ...
    public void resetDatabase() {
        // Generamos el hash para 'admin123' aquí mismo, usando la misma librería que la app.
