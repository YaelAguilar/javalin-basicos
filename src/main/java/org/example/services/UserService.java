...
import org.example.exceptions.NotFoundException; // ¡Necesitaremos esta nueva excepción!
...
public class UserService {
    ...
    public UserDTO registerWaiter(RegisterRequest request) {
        ...
        newUser.setRole(Role.WAITER); // Los usuarios registrados por esta vía siempre son meseros.
