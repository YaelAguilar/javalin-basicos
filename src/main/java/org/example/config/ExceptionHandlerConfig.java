...
public class ExceptionHandlerConfig {
    ...
    // Se crea una instancia estática del logger para esta clase. Es una práctica estándar.
    private static final Logger logger = LoggerFactory.getLogger(ExceptionHandlerConfig.class);

    public static void register(Javalin app) {
        // Maneja nuestras excepciones personalizadas (BadRequest, Unauthorized, etc.)
